extension PNG {
    ...
    public struct Layout {
        ...
        ///     `false`.
        public init(format: PNG.Format, interlaced: Bool = false) {
...
extension PNG.Layout {
    init?(
        ...
        guard let format: PNG.Format = .recognize(
            standard: standard, pixel: pixel,
...
extension PNG.Layout {
    var palette: PNG.Palette? {
        ...
        case    .bgr8       (palette: let palette, fill: _, key: _),
            ...
            return palette.isEmpty ? nil : .init(
                entries: palette.map {
                    ($0.r, $0.g, $0.b)
                }
            )
    ...
    var transparency: PNG.Transparency? {
        ...
        case    .indexed1   (palette: let palette, fill: _),
            ...
            .indexed4   (palette: let palette, fill: _),
            .indexed8   (palette: let palette, fill: _):
            guard let last: Int = (palette.lastIndex{ $0.a != .max }) else {
                return nil
            }
