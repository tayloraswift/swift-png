...
extension __Entrypoint.Benchmark.Decode {
    public static func rgba8(path: String, trials: Int) -> [(time: Int, hash: Int)] {
...
extension __Entrypoint.Benchmark.Encode {
    public static func rgba8(level: Int, path: String, trials: Int) -> (
        [(time: Int, hash: Int)],
        Int
    ) {
...
extension __Entrypoint.Benchmark.Dictionary {
    public static func updateRemove(count: Int = 1 << 22) -> (baseline: Int, accelerated: Int) {
