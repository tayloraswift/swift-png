extension PNG {
    ...
    public struct SuggestedPalette {
        ...
        public init(name: String, entries: Entries) {
...
extension PNG.SuggestedPalette {
    ...
    public init(parsing data: [UInt8]) throws {
        ...
        case 8:
            ...
            self.entries = .rgba8(
                stride(from: k + 2, to: data.endIndex, by: 6).map {
                    (base: Int) -> (
        ...
        case 16:
            ...
            self.entries = .rgba16(
                stride(from: k + 2, to: data.endIndex, by: 10).map {
                    (base: Int) -> (
                        color: (r: UInt16, g: UInt16, b: UInt16, a: UInt16),
                        frequency: UInt16
                    ) in
                    (
                        (
