...
@Suite enum ErrorHandling {
    ...
    @Test static func InvalidIHDRChecksum() throws {
        do {
            try decode("xhdn0g08")
        } catch PNG.LexingError.invalidChunkChecksum(
            declared: 1129534797,
            computed: 1443964200
        ) {
        }
    ...
    @Test static func InvalidIDATChecksum() throws {
        do {
            try decode("xcsn0g01")
        } catch PNG.LexingError.invalidChunkChecksum(
            declared: 1129534797,
    ...
    private static func decode(_ name: String) throws {
