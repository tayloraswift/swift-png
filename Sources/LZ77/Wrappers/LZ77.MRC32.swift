extension LZ77 {
    ...
    @frozen @usableFromInline struct MRC32 {
        @usableFromInline var single: UInt32
        @usableFromInline var double: UInt32
...
extension LZ77.MRC32: LZ77.StreamIntegral {
    ...
    @inlinable mutating func update(from start: UnsafePointer<UInt8>, count: Int) {
    ...
    @inlinable var checksum: UInt32 { self.double << 16 | self.single }
}
