...
extension LZ77.HuffmanTree<UInt16> {
    static var runliteral: Self {
        .init(
            ...
            .init(repeating: 288 ..< 288, count: 6)
        )  // L10 ... L15
    }
}
extension LZ77.HuffmanTree<UInt8> {
    static var distance: Self {
        .init(
            symbols: .init(0 ... 31),
            levels: .init(repeating: 0 ..<  0, count: 4)  +
            [0 ..< 32]                              +
...
extension LZ77.HuffmanTree where Symbol: BinaryInteger {
    ...
    static func validate<Symbols, Lengths>(symbols: Symbols, normalizing lengths: Lengths)
    -> Self?
    ...
    static func validate<Symbols, Lengths>(symbols: Symbols, lengths: Lengths) -> Self?
        where   Symbols: Collection,        Lengths: Collection,
        Symbols.Element == Symbol, Lengths.Element == Int {
...
extension LZ77.HuffmanTree where Symbol: BinaryInteger {
    ...
    init<C>(frequencies: C, limit: Int)
        ...
        var heap: LZ77.Heap<Int, [Int]> = .init(
    ...
    private static func limitHeight<S>(_ uncompacted: S, to height: Int) -> [Int]
