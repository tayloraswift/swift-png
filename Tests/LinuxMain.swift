...
try reencode_png("Tests/interlace.png", output: "Tests/interlace_reconverted.png")
try reencode_png_stream("Tests/taylor.png", output: "Tests/taylor_reconverted.png")
